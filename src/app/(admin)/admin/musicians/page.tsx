...
const STATUS_LABELS: Record<string, string> = { draft: "Borrador", pending_review: "En revisi�n", published: "Publicado", rejected: "Rechazado" };`n`nconst STATUS_COLOR: Record<
    string,
